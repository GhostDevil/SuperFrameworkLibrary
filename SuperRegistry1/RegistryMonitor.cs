...
namespace SuperFramework.SuperRegistry
{
    ...
    public class RegistryMonitor : IDisposable
    {
        ...
        private RegChangeNotifyFilter _regFilter = SuperRegistry.RegChangeNotifyFilter.Key | SuperRegistry.RegChangeNotifyFilter.Attribute |
                                                   SuperRegistry.RegChangeNotifyFilter.Value | SuperRegistry.RegChangeNotifyFilter.Security;
