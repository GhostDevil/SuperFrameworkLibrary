...
namespace SuperFramework.SuperDate
{
    ...
    public class ChineseCalendar
    {
        ...
        private static SolarHolidayStruct[] sHolidayInfo = new SolarHolidayStruct[]{
            ...
            new SolarHolidayStruct(1, 26, 0, "国际麻风节"),
            new SolarHolidayStruct(2, 2, 0, "世界湿地日"),
            new SolarHolidayStruct(2, 7, 0, "国际声援蓝非日"),
            ...
            new SolarHolidayStruct(3, 3, 0, "国际海豹日 全国爱耳日"),
            new SolarHolidayStruct(3, 5, 0, "学雷锋纪念日"),
            new SolarHolidayStruct(3, 8, 0, "三八妇女节"), 
            ...
            new SolarHolidayStruct(3, 20, 0, "世界无肉日"),
            new SolarHolidayStruct(3, 21, 0, "世界睡眠日 世界森林日 消除种族歧视国际日 世界儿歌日"),
            new SolarHolidayStruct(3, 22, 0, "世界水日"),
            new SolarHolidayStruct(3, 23, 0, "世界气象日"),
            new SolarHolidayStruct(3, 24, 0, "世界防治结核病日"),
            new SolarHolidayStruct(3, 25, 0, "全国中小学生安全教育日"),
            ...
            new SolarHolidayStruct(4, 20, 0, "复活节"),
            new SolarHolidayStruct(4, 22, 0, "世界地球日"),
            new SolarHolidayStruct(4, 23, 0, "世界读书日"),
            new SolarHolidayStruct(4, 26, 0, "知识产权日 全国交通安全反思日 世界儿童日"),
            ...
            new SolarHolidayStruct(5, 8, 0, "世界红十字日 世界微笑日"),
            new SolarHolidayStruct(5, 15, 0, "国际家庭日 世界电信日"),
            new SolarHolidayStruct(5, 12, 0, "国际护士节"), 
            new SolarHolidayStruct(5, 18, 0, "国际博物馆日 全国助残日"), 
            new SolarHolidayStruct(5, 30, 0, "五洲运动纪念 全国助残日"), 
            new SolarHolidayStruct(5, 31, 0, "世界无烟日"), 
            new SolarHolidayStruct(6, 1, 0, "国际儿童节"), 
            new SolarHolidayStruct(6, 5, 0, "世界环境保护日"),
            new SolarHolidayStruct(6, 6, 0, "全国爱眼日"),
            new SolarHolidayStruct(6, 11, 0, "中国人口日"),
            //new SolarHolidayStruct(6, 15, 0, "父亲节"),
            new SolarHolidayStruct(6, 20, 0, "世界难民日"),
            new SolarHolidayStruct(6, 22, 0, "中国儿童慈善活动日"),
            new SolarHolidayStruct(6, 23, 0, "国际奥林匹克日"),
            new SolarHolidayStruct(6, 25, 0, "全国土地日"),
            new SolarHolidayStruct(6, 26, 0, "国际禁毒日"),
            new SolarHolidayStruct(6, 30, 0, "世界青年联欢节"),
            new SolarHolidayStruct(7, 1, 0, "建党节 香港回归纪念 世界建筑日"),
            new SolarHolidayStruct(7, 2, 0, "国际体育记者日"),
            new SolarHolidayStruct(7, 6, 0, "国际接吻日"),
            new SolarHolidayStruct(7, 7, 0, "抗日战争胜利纪念日"),
            new SolarHolidayStruct(7, 11, 0, "世界人口日"),
            new SolarHolidayStruct(7, 30, 0, "非洲妇女日"),
            new SolarHolidayStruct(8, 1, 0, "建军节"), 
            new SolarHolidayStruct(8, 6, 0, "国际电影节"), 
            new SolarHolidayStruct(8, 15, 0, "日本投降日"),
            new SolarHolidayStruct(9, 3, 0, "抗日战争胜利纪念日"), 
            new SolarHolidayStruct(9, 8, 0, "国际扫盲日"),
            new SolarHolidayStruct(9, 9, 0, "毛主席逝世纪念"), 
            new SolarHolidayStruct(9, 10, 0, "教师节"), 
            new SolarHolidayStruct(9, 12, 0, "世界清洁地球日 国际臭氧层保护日"),
            new SolarHolidayStruct(9, 16, 0, "世界和平日"),
            ...
            new SolarHolidayStruct(9, 28, 0, "国际聋人节"),
            new SolarHolidayStruct(10, 1, 1, "国庆节 国际音乐日 国际老人节"),
            new SolarHolidayStruct(10, 2, 1, "国庆节假日"),
            new SolarHolidayStruct(10, 3, 1, "国庆节假日"),
            new SolarHolidayStruct(10, 4, 0, "世界动物日"),
            new SolarHolidayStruct(10, 9, 0, "世界邮政日"),
            new SolarHolidayStruct(10, 10, 0, "辛亥革命纪念日"),
            new SolarHolidayStruct(10, 13, 0, "中国少年先锋队诞辰日"),
            new SolarHolidayStruct(10, 14, 0, "世界标准日"),
            new SolarHolidayStruct(10, 15, 0, "国际盲人节"),
            new SolarHolidayStruct(10, 16, 0, "世界粮食日"),
            new SolarHolidayStruct(10, 17, 0, "国际消除贫困日"),
            new SolarHolidayStruct(10, 22, 0, "世界传统医药日"),
            new SolarHolidayStruct(10, 24, 0, "联合国日"),
            new SolarHolidayStruct(10, 31, 0, "世界勤俭日"),
            new SolarHolidayStruct(11, 1, 0, "万圣节"),
            new SolarHolidayStruct(11, 8, 0, "中国记者日"),
            ...
            new SolarHolidayStruct(11, 17, 0, "国际大学生节"), 
            new SolarHolidayStruct(11, 21, 0, "世界问候日"), 
            new SolarHolidayStruct(11, 27, 0, "感恩节"), 
            new SolarHolidayStruct(12, 1, 0, "世界艾滋病日"), 
            new SolarHolidayStruct(12, 3, 0, "世界残疾人日"),
            new SolarHolidayStruct(12, 9, 0, "世界足球日 一二九运动纪念日"),
            new SolarHolidayStruct(12, 10, 0, "世界人权日"),
            new SolarHolidayStruct(12, 12, 0, "西安事变纪念日"),
            new SolarHolidayStruct(12, 13, 0, "南京大屠杀"),
        ...
        private static LunarHolidayStruct[] lHolidayInfo = new LunarHolidayStruct[]{
                ...
                new LunarHolidayStruct(4, 8, 0, "佛诞"), 
