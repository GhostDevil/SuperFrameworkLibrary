...
namespace SuperFramework.SuperEncrypt
{
    ...
    public static class PassWordHelper
    {
        ...
        /// <param name="salt">盐(Salt)混淆数据</param>
        public static string Md532Salt(string source, string salt)
        {
            return string.IsNullOrEmpty(source) ? source.Md532() : (string.Format("{0}『{1}』", source, salt)).Md532();
        }
        ...
        /// HmacSha1 加密
        /// </summary>
        public static string HmacSha1(string source, string keyVal)
        {
            if (string.IsNullOrEmpty(source)) return null;
            var encoding = Encoding.UTF8;
        ...
        /// HmacSha256 加密
        /// </summary>
        public static string HmacSha256(string source, string keyVal)
        {
            if (string.IsNullOrEmpty(source)) return null;
            var encoding = Encoding.UTF8;
            byte[] keyStr = encoding.GetBytes(keyVal);
        ...
        /// HmacSha384 加密
        /// </summary>
        public static string HmacSha384(string source, string keyVal)
        {
            if (string.IsNullOrEmpty(source)) return null;
            var encoding = Encoding.UTF8;
            byte[] keyStr = encoding.GetBytes(keyVal);
        ...
        /// HmacSha512 加密
        /// </summary>
        public static string HmacSha512(string source, string keyVal)
        {
            if (string.IsNullOrEmpty(source)) return null;
            var encoding = Encoding.UTF8;
            byte[] keyStr = encoding.GetBytes(keyVal);
        ...
        /// HmacMd5 加密
        /// </summary>
        public static string HmacMd5(string source, string keyVal)
        {
            if (string.IsNullOrEmpty(source)) return null;
            var encoding = Encoding.UTF8;
            byte[] keyStr = encoding.GetBytes(keyVal);
        ...
        /// HmacRipeMd160 加密
        /// </summary>
        public static string HmacRipeMd160(string source, string keyVal)
        {
            if (string.IsNullOrEmpty(source)) return null;
            var encoding = Encoding.UTF8;
            byte[] keyStr = encoding.GetBytes(keyVal);
        ...
        /// <returns></returns>  
        public static string AesStr(string source, string keyVal, string ivVal)
        {
            var encoding = Encoding.UTF8;
        ...
        /// <param name="ivVal">加密辅助向量</param>  
        /// <returns></returns>  
        public static string UnAesStr(string source, string keyVal, string ivVal)
        {
            var encoding = Encoding.UTF8;
            byte[] btKey = keyVal.FormatByte(encoding);
            byte[] btIv = ivVal.FormatByte(encoding);
        ...
        /// DES3 加密
        /// </summary>
        public static string Des3(string source, string keyVal)
        {
            try
            {
                TripleDES des = TripleDES.Create();

                des.Key = keyVal.FormatByte(Encoding.UTF8);
        ...
        /// DES3 解密
        /// </summary>
        public static string UnDes3(string source, string keyVal)
        {
            try
            {
