using System;
using SuperFramework.SuperMouseHelper.MouseKeyboardActivityMonitor.WinApi;

namespace SuperFramework.SuperMouseHelper.MouseKeyboardActivityMonitor
{
    /// <summary>
    ...
    public abstract class BaseHookListener : IDisposable
    {
        ...
        /// <remarks>
        /// Hooks are not active after instantiation. You need to use either <see cref="Enabled"/> property or call <see cref="Start"/> method.
        /// </remarks>
