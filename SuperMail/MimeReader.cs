...
namespace SuperLibrary.SuperMail
{
    /// <summary>
    ...
    public class MimeReader
    {
            ...
            foreach (string key in _entity.Headers.AllKeys)
            {
                switch (key)
                {
                    ...
                    case "content-transfer-encoding":
                        ...
                        _entity.ContentTransferEncoding = SuperLibrary.SuperMail.MimeReader.GetTransferEncoding(_entity.Headers[key]);
                        break;
                    case "content-type":
                        _entity.SetContentType(SuperLibrary.SuperMail.MimeReader.GetContentType(_entity.Headers[key]));
                        break;
                    case "mime-version":
        ...
        private void AddChildEntity(MimeEntity entity, Queue<string> lines)
        {
            ...
            SuperLibrary.SuperMail.MimeReader reader = new SuperLibrary.SuperMail.MimeReader(entity, lines);
