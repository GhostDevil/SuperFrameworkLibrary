...
namespace SuperFramework.SuperRemote
{
    public class RDPHelper
    {
        ...
        public static void Openrdesktop(string ip, string admin = null, string pw = null)
        {
        ...
        /// <param name="u"></param>
        private static void CreationBat(string batName, string fileContent, string u = null)
        {
        ...
        private static void writeBATFile(string fileContent, string filePath)
        {
        ...
        private static void ExecuteBat(string batName, string thisbatpath)
        {
            try
            {
